...
const Mining = () => (
  <section className="px-5 md:px-10 flex flex-col border-t dark:border-neutral-800 border-neutral-200 items-center h-full">
    <div className="text-left py-4 max-w-[1200px] w-full">
      <div className="flex mb-10 justify-between max-w-[1200px] w-full">
        ...
        <div className="text-right">
          ...
          <a href="/tensorlink/docs/community" className="text-smsm:text-base font-medium dark:text-blue-400 text-blue-600 hover:underline">
            Community
          </a>
        </div>
      </div>
      ...
      {/* Intro */}
      <p className="text-sm sm:text-base leading-relaxed dark:text-neutral-300 text-neutral-700 mb-5">
      ...
      <div className="mb-8">
        ...
        <SyntaxHighlighter
          language="bash"
          style={vscDarkPlus}
          className="text-xs sm:text-sm md:text-sm sm:text-base p-2 sm:p-4 rounded-lg mb-3"
        >
...
nvidia-smi`}
      ...
      <div className="mb-8">
        ...
        <div className="flex justify-center">
          <div className="relative max-w-[800px] w-full">
            <button
              onClick={() => navigator.clipboard.writeText('tar -xvf tensorlink-node-linux.v0.X.X.tar.gz && cd tensorlink-node')}
            ...
            <SyntaxHighlighter
              language="bash"
              style={vscDarkPlus}
              className="text-xs sm:text-sm md:text-sm sm:text-base p-2 sm:p-4 rounded-lg"
            >
      ...
      <div className="mb-8">
        ...
        <ul className="list-disc pl-6 text-sm sm:text-base leading-relaxed dark:text-neutral-300 text-neutral-700 mb-4">
          ...
          <li><strong>mining_script</strong> — optional, if mining is enabled, specify the executable path here.</li>
          <li><strong>priority_nodes</strong> — optional, if configuring private devices specify ["ip", port].</li>
        </ul>
        ...
        <div className="flex justify-center">
          <div className="relative max-w-[800px] w-full">
            ...
            <SyntaxHighlighter
                        language="json"
                        style={vscDarkPlus}
                        className="text-xs md:text-sm sm:text-base p-2 sm:p-4 rounded-lg"
                      >
                  {`
{
  "config": {
...
`}
    ...
    <div className="flex mt-8 mb-10 justify-between max-w-[1200px] w-full pt-8 border-t dark:border-neutral-800 border-neutral-200">
      ...
      <div className="text-right">
        <div className="text-sm dark:text-neutral-500 text-neutral-500 mb-1">Next</div>
        <a href="/tensorlink/docs/community" className="text-sm sm:text-base font-medium dark:text-blue-400 text-blue-600 hover:underline">
          Community & Support
        </a>
      </div>
    </div>
