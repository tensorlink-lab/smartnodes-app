    ...
    return (
        ...
        >
            <div className="flex justify-between items-center">
                <h1 className="font-extrabold text-xl sm:text-2xl mb-1 text-neutral-800 dark:text-white">Account</h1>
                {/* <ActionMenu style={{ zIndex: 100 }} onActionClick={handleActionClick} /> */}
            </div>
            <div className="mb-3 px-1 xs:mt-1">
                ...
                <div className="pr-20">
                    ...
                    <p className="text-xl xs:text-2xl mb-2">
                        {isNaN(Number(userBalance)) ? (
                            ...
                            <span className="text-sm ml-1">tSNO</span>
                            </>
                        )}
                    </p>
                </div>  
            ...
            <div className="flex flex-wrap gap-3 items-center mt-2 px-1">
                ...
                className="border border-gray-400 inline-block p-2 px-3 text-white bg-blue-500 hover:bg-blue-600 rounded-md text-sm md:text-base font-semibold cursor-pointer"
                >
                    Claim Rewards
                </a>
                <div>
