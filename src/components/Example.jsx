...
const Example = () => {
  return (
    <section className={`${styles.section} rounded-xl xs:px-4 px-4 sm:px-10 items-center flex flex-row`}>
      <div className="dark:bg-zinc-950 bg-zinc-200 sm:py-10 py-8 sm:px-12 lg:px-16 rounded-2xl px-7 flex flex-col sm:mx-0 z-20 border border-gray-300 dark:border-gray-800 shadow-lg transition-all hover:shadow-xl">
        <div className="hidden xs:flex space-x-4 mt-5">
          <a
            ...
            className="flex items-center px-4 py-2 bg-black text-white text-sm font-semibold rounded-full hover:bg-gray-800 transition-transform duration-500 hover:scale-105"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="px-4 py-2 bg-red-400 text-white text-sm font-semibold rounded-full hover:bg-red-600 transition-transform duration-500 hover:scale-105"
          >
            PyPI - Latest
          </a>
        </div>
          ...
          <div className="mt-6 max-w-2xl">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <a href="tensorlink/docs" className="w-full sm:w-auto">
                <button className="px-8 py-3 bg-purple-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-transform duration-500 hover:scale-105 w-full h-12 flex items-center justify-center border border-gray-200">
                  Documentation
                </button>
              </a>
              <a href="tensorlink/localhostGPT" className="w-full sm:w-auto">
                <button className="px-8 py-3 border-2 border-black dark:border-gray-500 bg-black hover:bg-gray-900 text-white font-medium rounded-lg w-full h-12 flex items-center justify-center transition-transform duration-500 hover:scale-105">
                  Demo
                </button>
              </a>
              <a href="https://discord.com/invite/aCW2kTNzJ2" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                <button className="px-8 py-3 border-2 border-black dark:border-gray-300 bg-indigo-700 hover:bg-blue-700 text-white font-medium rounded-lg w-full h-12 flex items-center justify-center transition-transform duration-500 hover:scale-105">
                  Discord
                </button>
              </a>
            </div>
