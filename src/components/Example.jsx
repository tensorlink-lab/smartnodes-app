    ...
    <section className="relative w-full h-full">
      <section className="w-full max-w-7xl mx-auto sm:px-4 px-2 py-6">
        <div className="relative">
          {/* Header Section */}
          <div className="bg-zinc-200 dark:bg-zinc-950 rounded-2xl px-6 sm:px-12 py-5 md:pt-8 border border-gray-300 dark:border-gray-800 shadow-lg mb-6">
            <div className="max-w-3xl mb-6">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <a 
                  href="https://tensorlink.io" target="_blank" rel="noopener noreferrer"
          ...
          {/* Mission / Supporting Statement */}
          <div className="max-w-3xl mx-auto text-center my-20 max-w-[800px]">
            <h3 className="font-semibold text-2xl md:text-3xl text-gray-800 dark:text-gray-200 leading-snug mb-3">
              <span className="text-blue-400">Abundant</span>, <span className="text-purple-400">community-owned</span>, truly <span className="text-red-400">private</span> AI
            </h3>
            <p className="max-w-2xl mx-auto text-gray-600 dark:text-gray-400 text-sm sm:text-base md:text-md">
              Tensorlink provides common AI services powered by a public P2P network. Run your own node to obfuscate your input data, contribute compute, earn rewards, and secure your AI workloads.
            </p>
          </div>
