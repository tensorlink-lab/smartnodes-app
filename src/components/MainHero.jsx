            ...
            <div className="flex-1 w-full flex-col items-center max-w-xl sm:min-w-[350px] z-0 mx-3 sm:mx-5 md:mx-10 py-6 mb-5">
              ...
              <div className="mt-6 mr-2">
                <p className="text-gray-700 dark:text-gray-300 text-md xs:text-lg leading-relaxed max-w-lg">
                  Smartnodes connects devices around the world into collaborative peer-to-peer compute and data processing networks. By uniting shared resources, Smartnodes powers AI, scientific research, and large-scale computing tasks, turning everyday devices into contributors to global problem-solving.
                </p>
              </div>
